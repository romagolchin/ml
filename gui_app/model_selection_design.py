...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.selectMetric = QtWidgets.QComboBox(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.selectMetric.sizePolicy().hasHeightForWidth())
        self.selectMetric.setSizePolicy(sizePolicy)
        self.selectMetric.setObjectName("selectMetric")
        self.verticalLayout_3.addWidget(self.selectMetric)
        self.checkShowOnlyBest = QtWidgets.QCheckBox(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.checkShowOnlyBest.sizePolicy().hasHeightForWidth())
        self.checkShowOnlyBest.setSizePolicy(sizePolicy)
        self.checkShowOnlyBest.setObjectName("checkShowOnlyBest")
        self.verticalLayout_3.addWidget(self.checkShowOnlyBest)
        ...
        self.verticalLayout_3.addWidget(self.btnGo)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkShowOnlyBest.setText(_translate("MainWindow", "Show only the best"))
